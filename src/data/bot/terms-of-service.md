...
- "Server" means `UncivServer.xyz` multiplayer game server.

- "Bot" means `UncivGames Democracy Bot`, discord app accessible on `https://discord.com`

- "Service" means Bot and Server, both of which are free to use and open source projects

- "We" ("Us", "Our") means Service and their owner or operators.

- "You" ("Your") means you, that is yourself, the other party who is accessing or using our Service,
  or any other Person who on Your behalf is accessing or using our Service.
...
- "Feedback" means feedback, ideas, innovations, suggestions or corrections sent by You regarding
  the attributes, performance, features or content of the Service.

## Introduction

This are the Terms of Service governing the use of our Service which set out the rights and
obligations regarding the use of the Service.

## Acceptance of Terms

Your access to and use of the Service is conditioned on Your acceptance of and compliance with
these Terms of Service.<br>
By accessing or using the Service You are entering into Agreement with Us.<br>
If You disagree with, or don't understand any part of these Terms of Service then You must not
access or use the Service.

If You are entering into this Agreement on behalf of other Person, then You represent and
...
- [Discord's Terms of Service](https://discord.com/terms/), by using our Bot, you agree to comply
...
By accessing or using the Service You represent and warrant that You are at least 13 years of age.</br>
If You are under 13 years old, You may not access or use the Service under any circumstances
or for any reason, and may not provide any Personal Information to or on the Service.

If You are located within the European Union, by accessing or using the Service You represent and
warrant that You are at least 16 years of age.</br>
If You are under 16 years old, You may not access or use the Service under any circumstances or for
any reason, and may not provide any Personal Information to or on the Service.

## Jurisdiction Restrictions

If You reside in a jurisdiction where it is forbidden by law to access or use the Service,
...
jurisdiction if the use of the Service is allowed.
...
in email address, domain name or intellectual property of the Service or similar resource used by
You in connection with the Service.

## User Responsibility

You are solely responsible for your actions while using the Service.</br>
...
irrevocable, royalty-free, worldwide right and license to use, modify, reproduce,
...
By sharing content through the Service, you grant Us, and the public, a non-exclusive,
irrevocable, royalty-free, worldwide right and transferable license, to use, modify,
and distribute that content, unless such usage contradicts these Terms of Service.</br>
You represent and warrant that you have all necessary rights to share the content.

## Modifications and Interruptions

We may modify, update, interrupt or suspend our Service at any time without notice for variety of
reasons, including, but not limited to, the following:

- Changes to Our Terms of Service, including this Modifications and Interruptions clause and
  including any other documents from Integration of Additional Terms clause.
- Updates to our Service features or functionality.
- Technical issues or upgrades
- Changes in laws or regulations
- Service decisions or changes in strategy
- Security concerns or vulnerabilities
- Other legitimate Service purposes
...
No responsibility will be accepted by Us for:
...
To the maximum extent permitted under applicable law, We make no representation of any kind,
...
information on the Service, including, but not limited to, attributes, performance, functionality or
security.

Without limitation to the foregoing, the Service is provided to You "as is" and "as available" and
with all faults and defects without warranty of any kind</br>
Your access to and use of the Service is at Your own risk.

Without limitation to the foregoing, We make no representation of any kind,
and make no undertaking of any kind, and disclaim all warranties or guarantees of any kind,
whether express, implied, or otherwise that the Service will meet Your requirements,
...
limitations on applicable statutory rights, so some or all of the above exclusions
...
To the maximum extent permitted by applicable law, in no event will We be liable to You for
any claims, damages, losses or other liability caused, alleged to be caused,
or otherwise whether special, incidental, consequential, punitive, direct or indirect as to the:

- Your access or use of the Service
- Any interruption or suspension of our Service
...
- Third-party software or third-party hardware used with the Service
- Technical difficulties with third-party services
- Internet connectivity issues
- Any other matter related to our Service

arising from, out of, or in connection with Your access or use of our Service or other dealings in the same,
...
You ("Indemnifying Party") agree to defend, indemnify and hold Us harmless,
...
Your continued use of the Service after an update will constitute acceptance of the Terms.
...
If You wish to terminate the Agreement arbitrarily, You may simply discontinue using the Service.<br>
By Your arbitrary termination You immediately lose Your right to use the Service including all
...
sole discretion, to terminate Agreement with You, to stop serving the Service, and to block or
prevent Your future access to and use of the Service for any reason, including, but not limited to,
the following:

- If We are unable to continue to serve the Service due to technical or financial reasons.
- Any misuse of the Service from Your side, including, but not limited to, attempts to compromise its
